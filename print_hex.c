...
/**
 * print_x - takes an unsigned int and prints it in lowercae hex notation 44
...
/**
 * print_X - takes an unsigned int and prints it in uppercase hex notation 55
 * @X: unsigned int to print
 *
 * Return: Number of digits printed
 */
 ...
 */
static unsigned long _pow(unsigned int base, unsigned int exponent) 72
{
	unsigned int i;
